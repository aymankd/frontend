...
export function PlayerCardSkelton() {
  return (
    <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl ease-in-out">
      <a href="#">
        <div className="rounded-t-lg object-cover w-full h-96 flex justify-center items-center w-full h-48 bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
          <svg
